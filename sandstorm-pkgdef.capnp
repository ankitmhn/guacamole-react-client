...
const pkgdef :Spk.PackageDefinition = (
  ...
  id = "sfn1e7jm4yfy7ez2mnpa3u1v8ewn6uckxzxps173a8psjxuxy2sh",
  ...
  manifest = (
    ...
    appTitle = (defaultText = "Guacamole Client"),
    ...
    metadata = (
      ...
      shortDescription = (defaultText = "SSL Guacamole Client"),
...
const myCommand :Spk.Manifest.Command = (
  ...
  argv = ["/sandstorm-http-bridge", "3000", "--", "node", "server.js"],
  environ = [
